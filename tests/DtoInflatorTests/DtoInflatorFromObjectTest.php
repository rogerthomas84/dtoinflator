...
class DtoInflatorFromObjectTest extends TestCase
{
    ...
    public function testShortKeyedUserSingleObject()
    {
        $foodOne = new stdClass();
        $foodOne->ingredient = 'Grain';
        $foodOne->c = 'Orange';

        $objOne = new stdClass();
        $objOne->fn = 'Joe';
        $objOne->ln = 'Bloggs';
        $objOne->keyNotInShortArray = 'FooBar';
        $objOne->food = $foodOne;

        $dto = ExampleUserDto::inflateSingleObject($objOne, true);
        ...
        $this->assertEquals('Orange', $dto->food->colour);
    }

    public function testShortKeyedUserSingleMultipleObject()
    {
        $foodOne = new stdClass();
        $foodOne->ingredient = 'Grain';
        $foodOne->c = 'Orange';
        ...
        $foodTwo = new stdClass();
        $foodTwo->ingredient = 'Rice';
        $foodTwo->c = 'Brown';

        $objTwo = new stdClass();
        $objTwo->fn = 'Jane';
        $objTwo->ln = 'Doe';
        $objTwo->keyNotInShortArray = 'Abc';
        $objTwo->food = $foodTwo;

        $dtos = ExampleUserDto::inflateMultipleObjects(
            [
                $objOne,
                $objTwo
            ],
